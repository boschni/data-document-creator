...
program
  ...
  .option(
    ...
    "The directory to output the processed documents to. If this param is not set the output is sent to stdout."
  )
  .option(
    "-r, --property-removal-indicator <indicator>",
    "Remove all properties containing this value. Defaults to '__NILL__'."
  )
  .option(
    "-s, --skip-schema-validation",
    "Skip JSON schema validation. Defaults to false."
  )
